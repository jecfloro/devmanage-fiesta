...
try {
    ...
    $select_email = $conn->query("SELECT * FROM appsysusers WHERE user_email = '$user_email'");
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="font-family:"Quicksand"; font-size:20px; color:#202020; font-weight:bold; padding-left:20px; padding-right:20px;">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
        ...
        $insert = $conn->prepare("INSERT INTO `appsysusers` (`user_email`, `user_password`, `isCustomer`, `user_recoveryCode`, `user_activationCode`, `user_secret`, `lat`, `long`) VALUES ('$user_email', '$ii_password', 1, '$recoveryCode', '$activationCode', '$secret', '$lat', '$long')");
        $insert->execute();
