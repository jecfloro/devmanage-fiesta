...
$tempproductid = $_SESSION["tempproductid"];
...
try {
    ...
    for ($index = 0; $index < $countfiles; $index++) {
        ...
        $destination  = "../../../uploads_images/{$basename}";
        move_uploaded_file( $file_tmp, $destination );

        $insert = $conn->prepare("INSERT INTO msc_images (`FK_mscProducts`, `fileCode`, `fileName`, `fileExtension`, `fileUploaded`) VALUES ('$tempproductid', '$basename', '$file_name', '$file_ext', '$todaysDate')");
        $insert->execute();
