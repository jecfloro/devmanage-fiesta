...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled aside-fixed aside-default-enabled user-select-none">
                                    ...
                                    <div class="row g-xl-12">
                                        <div class="card">
                                            <div class="card-header border-0 pt-6">
                                                <div class="card-title">
                                                    <div class="d-flex align-items-center position-relative my-1">
                                                        <i class="ki-duotone ki-magnifier fs-3 position-absolute ms-5"><span class="path1"></span><span class="path2"></span></i> <input type="text" data-kt-hrdepartment-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search Department" />
                                                    </div>
                                                </div>
                                                <div class="card-toolbar">
                                                    <!-- Search -->
                                                    <div class="d-flex justify-content-end gap-3 flex-wrap" data-kt-user-table-toolbar="base">
                                                        <button type="button" class="btn btn-primary d-flex align-items-center ps-5" data-bs-toggle="modal" data-bs-target="#modal_hrDepartments">
                                                    ...
                                                    <div class="modal fade" id="modal_hrDepartments" tabindex="-1" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                                            <div class="modal-content">
                                                                <div class="modal-header" id="modal_hrDepartmentsHeader">
                                                                ...
                                                                <div class="modal-body px-5 my-7">
                                                                    <div>
                                                                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="modal_hrDepartments" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#modal_hrDepartmentsHeader" data-kt-scroll-wrappers="#modal_hrDepartments" data-kt-scroll-offset="300px">
                                                                            <div class="fv-row mb-0">
                                                                                ...
                                                                                <div class="input-group mb-5">
                                                                                    ...
                                                                                    <select name="" id="ii_group" class="form-control form-control-select">
                                                                                        <option value="" selected>Select Department Group</option>
                                                                            ...
                                                                            <div class="fv-row mb-0">
                                                                                ...
                                                                                <div class="input-group mb-5">
                                                                                    ...
                                                                                    <input type="text" class="form-control" id="ii_departmentname" placeholder="Department Name" aria-label="Department Name" aria-describedby="ii_departmentname" />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="text-center pt-10">
                                                                            ...
                                                                            <button type="submit" class="btn btn-primary" data-ii-dept-modal-action="submit">
                                                    ...
                                                    <div class="modal fade" id="modal_hrDepartmentsEdit" tabindex="-1" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                                            <div class="modal-content">
                                                                <div class="modal-header" id="modal_hrDepartmentsHeader">
                                                                ...
                                                                <div class="modal-body px-5 my-7">
                                                                    <div>
                                                                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="modal_hrDepartments" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#modal_hrDepartmentsHeader" data-kt-scroll-wrappers="#modal_hrDepartments" data-kt-scroll-offset="300px">
                                                                            <div class="fv-row mb-0" hidden>
                                                                                ...
                                                                                <div class="input-group mb-5">
                                                                                    ...
                                                                                    <input type="text" class="form-control" id="ii_departmentcodeedit" placeholder="Department Code" aria-label="Department Code" aria-describedby="ii_departmentcodeedit" readonly />
                                                                                </div>
                                                                            </div>
                                                                            <div class="fv-row mb-0">
                                                                                <label class="fw-semibold fs-6 mb-2">Group</label>
                                                                            ...
                                                                            <div class="fv-row mb-0">
                                                                                ...
                                                                                <div class="input-group mb-5">
                                                                                    ...
                                                                                    <input type="text" class="form-control" id="ii_departmentnameedit" placeholder="Department Name" aria-label="Department Name" aria-describedby="ii_departmentnameedit" />
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="text-center pt-10">
                                                                            ...
                                                                            <button type="submit" class="btn btn-primary" data-ii-deptedit-modal-action="submit">
                                                                                <span class="indicator-label">
                                                                                    Submit
                                                                                </span>
                                                                            </button>
                                                    ...
                                                    <div class="modal fade" id="modal_hrDeparmentsDelete" tabindex="-1" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                                            <div class="modal-content">
                                                                <div class="modal-header" id="modal_hrDeparmentsHeaderDelete">
                                                                    <h2 class="fw-bold">Delete Department</h2>
                                                                    <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal">
                                                                        <i class="ki-duotone ki-cross fs-1"><span class="path1"></span><span class="path2"></span></i>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-body px-5 my-7">
                                                                    <div>
                                                                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="modal_hrDeparmentsDeleteContainer" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#modal_hrDeparmentsHeaderDelete" data-kt-scroll-wrappers="#modal_hrDeparmentsDeleteContainer" data-kt-scroll-offset="300px">
                                                                            <div class="fv-row mb-0" hidden>
                                                                                <label class="fw-semibold fs-6 mb-2">Code</label>
                                                                                <div class="input-group mb-5">
                                                                                    <span class="input-group-text">
                                                                                    ...
                                                                                    <input type="text" class="form-control" id="ii_departmentcodedelete" placeholder="Department Code" aria-label="Department Code" aria-describedby="ii_departmentcodedelete" readonly />
                                                                                </div>
                                                                            </div>
                                                                            <div class="fv-row mb-0">
                                                                                <label class="fw-semibold fs-6 mb-2">Password</label>
                                                                        ...
                                                                        <div class="text-center pt-10">
                                                                            ...
                                                                            <button type="submit" class="btn btn-primary" data-ii-deptdelete-modal-action="submit">
                                                                                <span class="indicator-label">
                                                                                    Submit
                                                                                </span>
                                                                            </button>
                                            ...
                                            <div class="card-body py-4">
                                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="tb_hrDepartments">
                                                    <thead>
                                                    ...
                                                    <tbody class="text-gray-600 fw-semibold">
                                                        <?php if (count($rselect_department) > 0) { ?>
                                                            <?php for ($ii = 0; $ii < count($rselect_department); $ii++) { ?>
                                                                <tr>
                                                                    <td class="">
                                                                        <?php echo $rselect_department[$ii]["department_name"]; ?>
                                                                    </td>
                                                                    <td class="text-end datainput">
                                                                        <div class="d-flex justify-content-end gap-2">
                                                                            <div class="tableaction-hover rounded pt-2 pb-1 ps-3 pe-3" data-ii-val="<?php echo $rselect_department[$ii]["PK_appsysDepartments"]; ?>" data-ii-input-edit-action="edit">
                                                                                <i class="ki-duotone ki-notepad-edit fs-2x">
                                                                                    <span class="path1"></span>
                                                                                    <span class="path2"></span>
                                                                                </i>
                                                                            </div>
                                                                            <div class="tableaction-hover rounded pt-2 pb-1 ps-3 pe-3" data-ii-val="<?php echo $rselect_department[$ii]["PK_appsysDepartments"]; ?>" data-ii-input-delete-action="delete">
    ...
    <script src="../../assets/js/datatables/hr-department.js"></script>
    <script type="module" src="../../app/js/main.hrDepartment.js"></script>
</body>
