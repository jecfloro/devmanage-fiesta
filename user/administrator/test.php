...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled aside-fixed aside-default-enabled user-select-none">
                                    ...
                                    <div class="row g-xl-12">
                                        <div class="card">
                                                                    ...
                                                                    <form id="kt_modal_add_user_form" class="form" action="#">
                                                                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                                            <div class="fv-row mb-0">
                                                                                <label class="fw-semibold fs-6 mb-2">User Code</label>
                                                                                <div class="input-group mb-5">
                                                                                    <span class="input-group-text" id="ii_usercode">
                                                                                        <i class="ki-duotone ki-check-circle text-primary fs-3">
                                                                                            <span class="path1"></span>
                                                                                            <span class="path2"></span>
                                                                                        </i>
                                                                                    </span>
                                                                                    <input type="text" class="form-control" placeholder="User Code" aria-label="User Code" aria-describedby="ii_usercode" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="fv-row mb-0">
                                                                                <label class="fw-semibold fs-6 mb-2">Last Name</label>
                                                                                <div class="input-group mb-5">
                                                                                    <span class="input-group-text" id="ii_lastname">
                                                                                        <i class="ki-duotone ki-check-circle text-primary fs-3">
                                                                                            <span class="path1"></span>
                                                                                            <span class="path2"></span>
                                                                                        </i>
                                                                                    </span>
                                                                                    <input type="text" class="form-control" placeholder="Last Name" aria-label="Last Name" aria-describedby="ii_lastname" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="fv-row mb-0">
                                                                                <label class="fw-semibold fs-6 mb-2">First Name</label>
                                                                                <div class="input-group mb-5">
                                                                                    <span class="input-group-text" id="ii_firstname">
                                                                                        <i class="ki-duotone ki-check-circle text-primary fs-3">
                                                                                            <span class="path1"></span>
                                                                                            <span class="path2"></span>
                                                                                        </i>
                                                                                    </span>
                                                                                    <input type="text" class="form-control" placeholder="First Name" aria-label="First Name" aria-describedby="ii_firstname" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="fv-row mb-0">
                                                                                <label class="fw-semibold fs-6 mb-2">Middle Name</label>
                                                                                <div class="input-group mb-5">
                                                                                    <span class="input-group-text" id="ii_middlename">
                                                                                        <i class="ki-duotone ki-check-circle text-primary fs-3">
                                                                                            <span class="path1"></span>
                                                                                            <span class="path2"></span>
                                                                                        </i>
                                                                                    </span>
                                                                                    <input type="text" class="form-control" placeholder="Middle Name" aria-label="Middle Name" aria-describedby="ii_middlename" />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                            ...
                                            <div class="card-body py-4">
                                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="tb_hrGroupDepartments">
                                                    <thead>
    ...
    <script src="../../assets/js/datatables/hr-groupdepartments.js"></script>
</body>
