...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled aside-fixed aside-default-enabled user-select-none">
                                    ...
                                    <div class="row g-xl-12">
                                        <div class="card">
                                            <div class="card-header border-0 pt-6">
                                                <div class="card-title">
                                                    <div class="d-flex align-items-center position-relative my-1">
                                                        <i class="ki-duotone ki-magnifier fs-3 position-absolute ms-5"><span class="path1"></span><span class="path2"></span></i> <input type="text" data-kt-hrpositions-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search Position" />
                                                    </div>
                                                </div>
                                                <div class="card-toolbar">
                                                    <!-- Search -->
                                                    <div class="d-flex justify-content-end gap-3 flex-wrap">
                                                        <button type="button" class="btn btn-primary d-flex align-items-center ps-5" data-bs-toggle="modal" data-bs-target="#modal_hrPositions">
                                                    ...
                                                    <div class="modal fade" id="modal_hrPositions" tabindex="-1" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                                            <div class="modal-content">
                                                                <div class="modal-header" id="modal_hrPositionsHeader">
                                                                    ...
                                                                    <div>
                                                                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="modal_hrGroupDeparments" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#modal_hrGroupDeparmentsHeader" data-kt-scroll-wrappers="#modal_hrGroupDeparments" data-kt-scroll-offset="300px">
                                                                            <div class="fv-row mb-0">
                                                                                <label class="fw-semibold fs-6 mb-2">Position Name</label>
                                                                                <div class="input-group mb-5">
                                                                                    ...
                                                                                    <input type="text" class="form-control" id="ii_positionname" placeholder="Position Name" aria-label="Position Name" aria-describedby="ii_positionname" />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="text-center pt-10">
                                                                            ...
                                                                            <button type="submit" class="btn btn-primary" data-ii-position-modal-action="submit">
                                                    ...
                                                    <div class="modal fade" id="modal_hrPositionsEdit" tabindex="-1" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                                            <div class="modal-content">
                                                                <div class="modal-header" id="modal_hrPositionsHeaderEdit">
                                                                ...
                                                                <div class="modal-body px-5 my-7">
                                                                    <div>
                                                                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="modal_hrPositionsEdit" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#modal_hrPositionsHeaderEdit" data-kt-scroll-wrappers="#modal_hrPositionsEdit" data-kt-scroll-offset="300px">
                                                                            <div class="fv-row mb-0" hidden>
                                                                                ...
                                                                                <div class="input-group mb-5">
                                                                                    ...
                                                                                    <input type="text" class="form-control" id="ii_positioncodeedit" placeholder="Position Code" aria-label="Position Code" aria-describedby="ii_positioncodeedit" readonly />
                                                                                </div>
                                                                            </div>
                                                                            <div class="fv-row mb-0">
                                                                                <label class="fw-semibold fs-6 mb-2">Position Name</label>
                                                                                <div class="input-group mb-5">
                                                                                    ...
                                                                                    <input type="text" class="form-control" id="ii_positionnameedit" placeholder="Position Name" aria-label="Position Name" aria-describedby="ii_positionnameedit" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="fv-row mb-0">
                                                                        ...
                                                                        <div class="text-center pt-10">
                                                                            ...
                                                                            <button type="submit" class="btn btn-primary" data-ii-positionedit-modal-action="submit">
                                                                                <span class="indicator-label">
                                                                                    Submit
                                                                                </span>
                                                                            </button>
                                                    ...
                                                    <div class="modal fade" id="modal_hrPositionsDelete" tabindex="-1" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                                            <div class="modal-content">
                                                                <div class="modal-header" id="modal_hrPositionsHeaderDelete">
                                                                    <h2 class="fw-bold">Delete Position</h2>
                                                                    <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal">
                                                                        <i class="ki-duotone ki-cross fs-1"><span class="path1"></span><span class="path2"></span></i>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-body px-5 my-7">
                                                                    <div>
                                                                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="modal_hrPositionsDelete" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#modal_hrPositionsHeaderDelete" data-kt-scroll-wrappers="#modal_hrPositionsDelete" data-kt-scroll-offset="300px">
                                                                            <div class="fv-row mb-0" hidden>
                                                                                <label class="fw-semibold fs-6 mb-2">Code</label>
                                                                                <div class="input-group mb-5">
                                                                                    <span class="input-group-text">
                                                                                    ...
                                                                                    <input type="text" class="form-control" id="ii_positioncodedelete" placeholder="Position Code" aria-label="Position Code" aria-describedby="ii_positioncodedelete" readonly />
                                                                                </div>
                                                                            </div>
                                                                            <div class="fv-row mb-0">
                                                                                <label class="fw-semibold fs-6 mb-2">Password</label>
                                                                        ...
                                                                        <div class="text-center pt-10">
                                                                            ...
                                                                            <button type="submit" class="btn btn-primary" data-ii-positiondelete-modal-action="submit">
                                                                                <span class="indicator-label">
                                                                                    Submit
                                                                                </span>
                                                                            </button>
                                            ...
                                            <div class="card-body py-4">
                                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="tb_hrPositions">
                                                    <thead>
                                                    ...
                                                    <tbody class="text-gray-600 fw-semibold">
                                                        <?php if (count($rselect_position) > 0) { ?>
                                                            <?php for ($ii = 0; $ii < count($rselect_position); $ii++) { ?>
                                                                <tr>
                                                                    <td class="">
                                                                        <?php echo $rselect_position[$ii]["position_name"]; ?>
                                                                    </td>
                                                                    <td class="text-end datainput">
                                                                        <div class="d-flex justify-content-end gap-2">
                                                                            <div class="tableaction-hover rounded pt-2 pb-1 ps-3 pe-3" data-ii-val="<?php echo $rselect_position[$ii]["PK_appsysPositions"]; ?>" data-ii-input-edit-action="edit">
                                                                                <i class="ki-duotone ki-notepad-edit fs-2x">
                                                                                    <span class="path1"></span>
                                                                                    <span class="path2"></span>
                                                                                </i>
                                                                            </div>
                                                                            <div class="tableaction-hover rounded pt-2 pb-1 ps-3 pe-3" data-ii-val="<?php echo $rselect_position[$ii]["PK_appsysPositions"]; ?>" data-ii-input-delete-action="delete">
    ...
    <script src="../../assets/js/datatables/hr-positions.js"></script>
    <script type="module" src="../../app/js/main.hrPositions.js"></script>
</body>
