                                                ...
                                                <div class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                                                    <div class="d-flex flex-stack flex-grow-1 px-9 pt-9 pb-3">
                                                        ...
                                                        <div class="d-flex flex-column text-end">
                                                            ...
                                                            <span class="text-gray-400 fw-semibold fs-6">Oct 8 - Oct 26 2020</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card  card-xl-stretch mb-5 mb-xl-8">
                                                <div class="card-body pt-5">
                                                    <div id="kt_stats_widget_9_carousel" class="carousel carousel-custom carousel-stretch slide" data-bs-ride="carousel" data-bs-interval="8000">
                                                        <div class="d-flex flex-stack flex-wrap">
                                                            <span class="text-gray-400 fw-bolder fs-4 pe-2">Today’s Schedule</span>
                                                            <ol class="p-0 m-0 carousel-indicators carousel-indicators-dots">
                                                        ...
                                                        <div class="carousel-inner pt-8">
                                                            <div class="carousel-item active">
                                                                <div class="carousel-wrapper">
                                                                    ...
                                                                    <div class="d-flex flex-stack pt-7">
                                                                        <span class="text-gray-400 fs-6 fw-semibold pe-2">234 E St. Broadwey NY..</span>
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="carousel-wrapper">
                                                                    ...
                                                                    <div class="d-flex flex-stack pt-7">
                                                                        <span class="text-gray-400 fs-6 fw-semibold pe-2">256 R St. Manhattan NY..</span>
                                                                        <a href="#" class="btn btn-light btn-sm fs-7 btn-color-muted fw-bolder px-5" data-bs-toggle="modal" data-bs-target="#kt_modal_select_location">Map</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="carousel-item">
                                                                <div class="carousel-wrapper">
                                                                    ...
                                                                    <div class="d-flex flex-stack pt-7">
                                                                        <span class="text-gray-400 fs-6 fw-semibold pe-2">745 R St. Romance DR..</span>
                                                                        <a href="#" class="btn btn-light btn-sm fs-7 btn-color-muted fw-bolder px-5" data-bs-toggle="modal" data-bs-target="#kt_modal_select_location">Map</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="carousel-item">
                                                                <div class="carousel-wrapper">
                                                                    ...
                                                                    <div class="d-flex flex-stack pt-7">
                                                                        <span class="text-gray-400 fs-6 fw-semibold pe-2">123 R St. Soulard NY..</span>
                                                                        <a href="#" class="btn btn-light btn-sm fs-7 btn-color-muted fw-bolder px-5" data-bs-toggle="modal" data-bs-target="#kt_modal_select_location">Map</a>
                                                                    </div>
                                                                </div>
                                                            </div>
