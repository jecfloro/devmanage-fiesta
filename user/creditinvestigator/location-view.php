...
try {
    ...
    $locationlist = $conn->prepare("SELECT * FROM mm_location WHERE FK_appsysUsers = '$uid' AND PK_mm_location = '$locationid'");
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                                ...
                                <ul class="breadcrumb fw-semibold fs-base my-1">
                                    ...
                                    <li class="breadcrumb-item text-dark">
                                        <a href="customer-view.php?uid=<?php echo $uid; ?>" class="text-dark">Customer</a>
                                    </li>
                                    <li class="breadcrumb-item text-dark">
                                        Location
                                    </li>
                                    <li class="breadcrumb-item text-dark">
                                        <?php echo $rlocationlist["addressNoteDescription"] ?>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="card mt-5">
                                        <div class="card-header">
                                            <div class="card-title m-0">
                                                <h3 class="fw-bold m-0"><?php echo $rlocationlist["addressNoteDescription"] ?></h3>
                                            </div>
                                        </div>
                                        <div class="card-body">
