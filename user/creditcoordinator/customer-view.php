                                    ...
                                    <div class="card">
                                        <div class="card-header cursor-pointer">
                                            <div class="card-title m-0 d-flex gap-3 align-items-center">
                                                <h3 class="fw-bolder m-0">CUSTOMER STATUS</h3>
                                            </div>
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true" style="">
                                                        ...
                                                        <div class="menu-item px-3">
                                                            ...
                                                            <?php } else { ?>
                                                                ...
                                                                <?php if ($ruser["isCoordinatorApproved"] != 2) { ?>
                                        ...
                                        <div class="card-body">
                                            <table class="table table-bordered">
                                                <tr>
                                                    <td>
                                                        <div class="d-flex flex-column">
                                                            <span class="fs-8">Status (Old / New)</span>
                                                            <span class="fw-bolder fs-4">
                                                                <?php if ($ruser["isNew"] == 1) { ?>
                                                                    NEW
                                                                <?php } else { ?>
                                                                    OLD
                                                                <?php } ?>
                                                    ...
                                                    <td>
                                                        <div class="d-flex flex-column">
                                                            <span class="fs-8">Approval Status</span>
                                                            <span class="fw-bolder fs-4">
                                                                <?php if ($ruser["isCoordinatorApproved"] == 1) { ?>
                                                                    APPROVED
                                                    ...
                                                    <td>
                                                        <div class="d-flex flex-column">
                                                            <span class="fs-8">CI Approval Status</span>
                                                            <span class="fw-bolder fs-4">
                                                                <?php if ($ruser["isCiApproved"] == 1) { ?>
                                                                    APPROVED
