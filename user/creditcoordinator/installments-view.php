                                        ...
                                        <div class="card-body d-flex flex-wrap gap-3">
                                            ...
                                            <div class="mb-3 border rounded p-3 col-12 bg-hover-light-secondary d-flex justify-content-between align-items-center">
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-5">
                                                        <svg height="40" width="40" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 303.188 303.188" xml:space="preserve">
                                                            <g>
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <div class="fw-bold fs-5 text-dark text-hover-primary text-wrap">Filename</div>
                                                    </div>
                                                </div>
                                                <div class="">
                                                    <i class="ki-duotone ki-cross-square fs-1 text-hover-primary">
