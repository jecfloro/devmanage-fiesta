...
var KTGeneralApexCharts = {
    ...
    init: function () {
        ...
        e = document.getElementById("kt_apexcharts_1"),
            ...
            r = KTUtil.getCssVariableValue("--bs-danger"), e && new ApexCharts(e, {
                series: [{
                    name: "Net Profit",
            ...
            function () {
                ...
                $.ajax({
                    url: '../../app/functions/charts/fn_paymentslate.php',
                    type: 'POST',
                    cache: false,
                    success: function (response) {
                        ...
                        e && new ApexCharts(e, {
                            series: [{
                                name: "Payments",
                                data: [status["range1"], status["range2"], status["range3"], status["range4"], status["range5"], status["range6"]]
                            }],
                            chart: {
                                fontFamily: "inherit",
                                type: "area",
                            ...
                            xaxis: {
                                categories: ["0-10", "11-25", "26-50", "51-70", "71-90", "> 90"],
                                axisBorder: {
                                    show: !1
                                },
                                axisTicks: {
